    ...
    <div >
        <div class="card">
            <div class="card-header">
                {{local[lang+'.orders']['pending_order_edit_heading']}}
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-header">
                                {{local[lang+'.orders']['pending_order_edit_order_details']}}
                            </div>
                            <div class="card-body">
                                <form :action='path+"/admin/order/pending/update"' method="post">
                                    ...
                                    <button type="submit" name = "pending"  value="0" class="btn btn-success float-right ml-3"><i class="fa fa-save"></i> {{local[lang+'.orders']['pending_order_save_button']}}</button>

                                    <button type="submit" name = "submit"  value="1" class="btn btn-primary float-right "><i class="fa fa-check"></i> {{local[lang+'.orders']['pending_order_submit_for_review']}}</button>
                            ...
                            <div class="card-body">
                                <form @submit.prevent="AddToBasket" class="form-inline">
                                    <div class="form-group mb-2">
                                        <label for="products">{{local[lang+'.orders']['pending_order_products']}}:</label>
                                    ...
                                    <div class="form-group mx-sm-3 mb-2 ">
                                        <label for="product_amount">{{local[lang+'.orders']['pending_order_amount']}}:</label>
                                        <input type="text" :placeholder="local[lang+'.orders']['pending_order_amount']" class="form-control ml-3" id="product_amount" name="product_amount" v-model="item.amount" required>
                                    </div>
                                ...
                                <table class="table table-bordered table-striped table-hover table-head-fixed">
                                    ...
                                    <tr class="text-center">
                                        <th>{{local[lang+'.orders']['pending_order_table_product_name']}}</th>
                                        <th>{{local[lang+'.orders']['pending_order_table_product_unit']}}</th>
                                        <th>{{local[lang+'.orders']['pending_order_table_product_price']}}</th>
                                        <th>{{local[lang+'.orders']['pending_order_table_amount']}}</th>
                                        <th>{{local[lang+'.orders']['pending_order_table_discount']}}</th>
                                        <th>{{local[lang+'.orders']['pending_order_table_sub_total']}}</th>
                                        <th>{{local[lang+'.orders']['pending_order_table_actions']}}</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-right text-bold h2">
                                            {{local[lang+'.orders']['approved_order_table_total']}}
                                        </td>
...
<script>
    ...
    export default {
        name: "EditPendingOrderComponent.vue",
