    ...
    <div >
        <div class="card">
            <div class="card-header">
                {{local[lang+'.orders']['draft_order_edit_heading']}}
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-header">
                                {{local[lang+'.orders']['draft_order_edit_order_details']}}
                            </div>
                            <div class="card-body">
                                <form :action='path+"/admin/order/create"' method="post">
                                    ...
                                    <button type="submit" name = "draft"  value="0" class="btn btn-success float-right ml-3"><i class="fa fa-save"></i> {{local[lang+'.orders']['draft_order_save_button']}}</button>
                                    <button type="submit" name = "submit"  value="1" class="btn btn-danger float-right "><i class="fa fa-business-time"></i> {{local[lang+'.orders']['draft_order_submit_for_review']}}</button>
                                </form>
                            </div>
                        </div>
                    </div>
