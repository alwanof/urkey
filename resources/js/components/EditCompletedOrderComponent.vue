    ...
    <div >
        <div class="card">
            <div class="card-header">
                {{local[lang+'.orders']['completed_order_edit_heading']}}
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-header">
                                {{local[lang+'.orders']['completed_order_edit_order_details']}}
                            </div>
                            <div class="card-body">
                                <form :action='path+"/admin/order/completed/update"' method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="text" :placeholder="local[lang+'.orders']['order_title']" class="form-control" id="order_title" name="order_title" v-model="order.title" readonly>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="order_description">{{local[lang+'.orders']['order_description']}}:</label>
                                        <textarea class="form-control" :placeholder="local[lang+'.orders']['order_description']" id="order_description" rows="3" name="order_description" v-model="order.desc" readonly></textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="note">{{local[lang+'.orders']['order_admin_note']}}:</label>
                                        <textarea class="form-control" :placeholder="local[lang+'.orders']['order_admin_note']" id="note" rows="3" name="note" v-model="order.note" required></textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="text" :placeholder="local[lang+'.orders']['order_discount']" class="form-control" id="discount" name="discount" v-model="order.discount" readonly>
                                        </div>
                                    </div>

                                    <button type="submit" name = "submit"  value="1" class="btn btn-success btn-block float-right "><i class="fa fa-save"></i> {{local[lang+'.orders']['approved_order_save_button']}}</button>
                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-striped table-hover table-head-fixed">
                                    ...
                                    <tr class="text-center">
                                        <th>{{local[lang+'.orders']['completed_order_table_product_name']}}</th>
                                        <th>{{local[lang+'.orders']['completed_order_table_product_unit']}}</th>
                                        <th>{{local[lang+'.orders']['completed_order_table_product_price']}}</th>
                                        <th>{{local[lang+'.orders']['completed_order_table_amount']}}</th>
                                        <th>{{local[lang+'.orders']['completed_order_table_discount']}}</th>
                                        <th>{{local[lang+'.orders']['completed_order_table_sub_total']}}</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-right text-bold h2">
                                            {{local[lang+'.orders']['completed_order_table_total']}}
                                        </td>
                    ...
                    <form @submit.prevent="updateAnItem">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Item Description" class="form-control" id="item_desc" name="item_desc" v-model="item.desc" readonly>
                            </div>
                            <div class="form-group">
                                <label for="item_amount">Amount Of Item :</label>
                                <input type="text" placeholder="Item Amount" class="form-control" id="item_amount" name="item_amount" v-model="item.amount" readonly>
                            </div>
                            <div class="form-group">
                                <label for="item_price">Item Price :</label>
                                <input type="text" placeholder="Item Price" class="form-control" id="item_price" name="item_price" v-model="item.price" readonly>
                            </div>
                            <div class="form-group">
                                <label for="item_discount">Item Discount :</label>
                                <input type="text" placeholder="Item Discount" class="form-control" id="item_discount" name="item_discount" v-model="item.discount" readonly>
                            </div>
                        </div>
...
<script>
    ...
    export default {
        name: "EditCompletedOrderComponent.vue",
